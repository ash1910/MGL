...
(function () {
  const nav = document.querySelector('.layout-navbar'),
    ...
    swiperCottonGreige = document.querySelector('#swiper-cotton-greige'),
    swiperCottonYarnDyed = document.querySelector('#swiper-cotton-yarn-dyed'),
    ReviewsPreviousBtn = document.getElementById('reviews-previous-btn'),
    ReviewsNextBtn = document.getElementById('reviews-next-btn'),
    ReviewsSliderPrev = document.querySelector('.swiper-button-prev-reviews'),
    ReviewsSliderNext = document.querySelector('.swiper-button-next-reviews'),
  ...
  // Multiple slides
  // --------------------------------------------------------------------
  if (swiperCottonGreige) {
    new Swiper(swiperCottonGreige, {
      slidesPerView: 2,
      spaceBetween: 20,
      navigation: {
  ...
  if (swiperCottonYarnDyed) {
    new Swiper(swiperCottonYarnDyed, {
      slidesPerView: 2,
      spaceBetween: 20,
      navigation: {
        prevEl: '.swiper-button-prev',
