        ...
        <div class="container">
          <div class="row gx-0 gy-6 g-lg-10">
              ...
              <a href="/" class="app-brand-link mb-6">
                <span class="app-brand-logo demo">
                  <span class="text-primary">
                    <img src="assets/images/MGL_LOGO_TR_BIG.png" alt="logo" width="60" height="">
                  </span>
                </span>
                <span class="app-brand-text demo footer-link fw-bold ms-2 ps-1">MAAS Global Limited</span>
              </a>
              <p class="footer-text footer-logo-description mb-6">
                We are a leading textile company that provides a wide range of textile products and services to our clients.
              </p>
            ...
            <div class="col-lg-2 col-md-4 col-sm-6">
              <h6 class="footer-title mb-6">Our Products</h6>
              <ul class="list-unstyled">
                <li class="mb-4">
                  <a href="/about-us" target="_blank" class="footer-link">About Us</a>
                </li>
                <li class="mb-4">
                  <a href="/customers" target="_blank" class="footer-link">Customers</a>
                </li>
                <li class="mb-4">
                  <a href="/services" target="_blank" class="footer-link">Services</a>
                </li>
                <li class="mb-4">
                  <a href="/media-awards" target="_blank" class="footer-link"
                    >Media & Awards</a
                  >
                </li>
                <li class="mb-4">
                  <a href="/news" target="_blank" class="footer-link">News</a>
                </li>
              </ul>
            </div>
            <div class="col-lg-2 col-md-4 col-sm-6">
              ...
              <ul class="list-unstyled">
                <li class="mb-4">
                  <a href="/life-at-maas" class="footer-link">Life at MAAS</a>
                </li>
                <li class="mb-4">
                  <a href="/blog" class="footer-link"
                    >Blog<span class="badge bg-primary ms-2">New</span></a
                  >
                </li>
                <li class="mb-4">
      ...
      <div class="footer-bottom py-3 py-md-5">
        <div
          ...
          <div class="mb-2 mb-md-0">
            ...
            <a href="/" target="_blank" class="fw-medium text-white">MAAS Global Limited,</a>
            <span class="footer-bottom-text"> All rights reserved.</span>
          </div>
          <div>
            <a href="javascript:;" class="me-1 text-white" target="_blank">
            ...
            <a href="javascript:;" class="text-white" target="_blank">
