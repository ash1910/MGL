                    ...
                    <div class="col-md-6 col-lg-12 col-xl-6">
                      <div class="d-flex align-items-center">
                        ...
                        <div>
                          ...
                          <h6 class="mb-0">
                            <a href="mailto:info@maasglobal.com" class="text-heading">info@maasglobal.com</a>
                          </h6>
                        </div>
                      </div>
                    </div>
                    <div class="col-md-6 col-lg-12 col-xl-6">
                      <div class="d-flex align-items-center">
                        ...
                        <div>
                          ...
                          <h6 class="mb-0"><a href="tel:+8801860177796" class="text-heading">+88 0186 0177 796</a></h6>
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            <div class="col-lg-7">
              <div class="card h-100">
                <div class="card-body">
                  ...
                  <p class="mb-6">
                    If you have any inquiries related to fabric sourcing, business growth opportunities, fabric quality, 
                      processing services, logistics, or our credit program, you’re in the right place.
                  </p>
                  <form>
                    <div class="row g-4">
                      <div class="col-md-6">
