        ...
        <div class="navbar navbar-expand-lg landing-navbar px-3 px-md-8">
          ...
          <div class="navbar-brand app-brand demo d-flex py-0 me-4 me-xl-8 ms-0">
            ...
            <a href="/" class="app-brand-link">
              ...
              <span class="app-brand-text demo menu-text fw-bold ms-2 ps-1">MGL</span>
            </a>
          </div>
          ...
          <div class="collapse navbar-collapse landing-nav-menu" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav me-auto">
              ...
              <li class="nav-item">
                <a class="nav-link fw-medium" href="/about-us.php">About Us</a>
              </li>
              <li class="nav-item">
                <a class="nav-link fw-medium" href="/customers.php">Customers</a>
              </li>
              <li class="nav-item">
                <a class="nav-link fw-medium" href="/suppliers.php">Suppliers</a>
              </li>
              <li class="nav-item">
                <a class="nav-link fw-medium" href="/sustainability.php">Sustainability</a>
              </li>
            </ul>
          </div>
          ...
          <ul class="navbar-nav flex-row align-items-center ms-auto">
            ...
            <!-- navbar button: Start -->
            <li>
              <a href="javascript:;" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addNewCallBack"
                ><span class="tf-icons icon-base ti tabler-login scaleX-n1-rtl me-md-1"></span
                ><span class="d-none d-md-block">Request a Quote</span></a
              >
            </li>
            <!-- navbar button: End -->
          </ul>
